import { Button, Dialog, styled, TextField, Typography, Box } from "@mui/material"
        ...
        <Dialog open={props.open} onClose={handleClose} PaperProps={{ sx : { maxWidth : "unset"}}}>
            <BoxStyle>
                ...
                </BoxImageStyle>
                {
                    account.view==="login" ?
                    <BoxInputFields>
                    <TextField variant="standard" onChange={handleValueChange} name="username" label="Enter Username"/>
                    { error && <TypographyError>Please enter valid username or password</TypographyError> }
                    <TextField variant="standard" onChange={handleValueChange} name="password" label="Enter Password"/>
                    <TypographyStyle>By continuing, you agree to Flipkart's Terms of Use and Privacy Policy.</TypographyStyle>
                    <ButtonLogin onClick={handleLogin}>Login</ButtonLogin>
                    <Typography style={{textAlign : "center"}}>OR</Typography>
                    <ButtonRequestOTP>Request OTP</ButtonRequestOTP>
                    <TypographyCreateAccount onClick={handleToggle}>New to Flipkart? Create an Account</TypographyCreateAccount>
                    </BoxInputFields>
                :
                    <BoxInputFields>
