        ...
        <div className="flex flex-col  sm:flex flex-col gap-4 w-1/4 px-1">
            ...
            <div className="flex flex-col bg-white rounded-sm shadow">
                ...
                <div className="flex items-center gap-5 px-4 py-4">
                    ...
                    <p className="hidden sm:block flex w-full justify-between font-medium text-gray-500">ACCOUNT SETTINGS</p>
                </div>
                ...
                <div className="flex items-center gap-5 px-4 py-4">
                    ...
                    <p className="hidden sm:block flex w-full justify-between font-medium text-gray-500">PAYMENTS</p>
                </div>
                <div className="hidden md:block md:flex flex-col pb-3 border-b text-sm">
                ...
                <div className="flex items-center gap-5 px-4 py-4 border-b">
                    ...
                    <Link className="hidden sm:block sm:flex w-full justify-between font-medium text-gray-500 hover:text-primary-blue" to="/">
                        MY CHATS
                        <span className='hidden md:block'><ChevronRightIcon /></span>
                    </Link>
                </div>
