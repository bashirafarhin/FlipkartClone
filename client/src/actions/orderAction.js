...
export const newOrder = (order) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/order/new`, order, config);
        dispatch({
...
export const myOrders = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/orders/me`,config);
        dispatch({
...
export const getOrderDetails = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/order/${id}`,config);
        dispatch({
...
export const getPaymentStatus = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/payment/status/${id}`,config);
        dispatch({
